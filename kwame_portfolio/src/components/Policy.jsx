            ...
            <>
                  ...
                  <ol>
                      ...
                      <ol>
                        ...
                        <li type="i">
                          ...
                          <p>
                            ...
                            Person zu ziehen. Darüber hinaus setzen wir beim
                            Besuch unserer Website Cookies sowie Analysedienste
                            ein. Nähere Erläuterungen dazu erhalten Sie unter
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        ausreichend. Die Abmeldung ist jederzeit möglich, zum
                        Beispiel über einen Link am Ende eines jeden
                        Newsletters. Alternativ können Sie Ihren Abmeldewunsch
                        gerne auch jederzeit an kwameboama@hotmail.com per
                        E-Mail senden
                      </p>
                    </li>
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        freiwillig getätigt werden. Die Datenverarbeitung zum
                        Zwecke der Kontaktaufnahme mit uns erfolgt nach Art. 6
                        Abs. 1 S. 1 lit. a DSGVO auf Grundlage Ihrer freiwillig
                        erteilten Einwilligung. Die für die Benutzung des
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        Fragen, Antworten, Meinungen oder Bewertungen (Beiträge)
                        zu veröffentlichen. In diesem Fall verarbeiten wir Ihren
                        Beitrag und veröffentlichen diesen auf unserer
                        Internetseite. Eine inhaltliche Prüfung findet nicht
                        statt. Rechtsgrundlage hierbei ist die von Ihnen nach
                        Art. 6 Abs. 1 lit. a) DSGVO erteilte Einwilligung. Die
                        Einwilligung können Sie nach Art. 7 Abs. 3 DSGVO
                        jederzeit widerrufen. Weiter werden das Datum und die
                        Uhrzeit der Einreichung, ein ggf. genutztes Pseudonym,
                        IP- und E-Mail-Adresse verarbeitet. Die Rechtsgrundlage
                        ergibt sich aus Art. 6 Abs. 1 lit. f. DSGVO. Unser
                        überwiegendes berechtigtes Interesse ergibt sich daraus
                        weitere Schritte einzuleiten oder zu unterstützen zu
                        können, wenn Ihr Beitrag rechtswidrig ist. Die im Rahmen
                        der Beiträge angegebenen Daten, werden von uns bis zum
                        Widerspruch durch den Nutzer dauerhaft gespeichert.
                      </p>
                    </li>
                  </ol>
                </li>
              ...
              <section>
                <li>
                  <p>
                    ...
                    richten auf Ihrem Endgerät keinen Schaden an, enthalten
                    keine Viren, Trojaner oder sonstige Schadsoftware. In dem
                    Cookie werden Informationen abgelegt, die sich jeweils im
                    Zusammenhang mit dem spezifisch eingesetzten Endgerät
                  ...
                  <p>
                    ...
                    unseres Angebots für Sie angenehmer zu gestalten. So setzen
                    wir sogenannte Session-Cookies ein, um zu erkennen, dass Sie
                  ...
                  <p>
                    ...
                    Website statistisch zu erfassen und zum Zwecke der
                    Optimierung unseres Angebotes für Sie auszuwerten (siehe
                    Ziff. 5). Diese Cookies ermöglichen es uns, bei einem
                    erneuten Besuch unserer Seite automatisch zu erkennen, dass
                    Sie bereits bei uns waren. Diese Cookies werden nach einer
                  ...
                  <p>
                    ...
                    gespeichert werden oder stets ein Hinweis erscheint, bevor
                    ein neuer Cookie angelegt wird. Die vollständige
                  ...
                  <ol>
                    <li type="a">
                      ...
                      <p>
                        ...
                        Tracking-Maßnahmen werden auf Grundlage des Art. 6 Abs.
                        1 S. 1 lit. f DSGVO durchgeführt. Mit den zum Einsatz
                        kommenden Tracking-Maßnahmen wollen wir eine
                        bedarfsgerechte Gestaltung und die fortlaufende
                        Optimierung unserer Webseite sicherstellen. Zum anderen
                        setzen wir die Tracking-Maßnahmen ein, um die Nutzung
                        unserer Webseite statistisch zu erfassen und zum Zwecke
                        ...
                        Datenverarbeitungszwecke und Datenkategorien sind aus
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        fortlaufenden Optimierung unserer Seiten nutzen wir
                        ...
                        <span>
                          (1600 Amphitheatre Parkway, Mountain View, CÆ 94043,
                          USA; im Folgenden „Google“).
                        </span>{" "}
                        In diesem Zusammenhang werden pseudonymisierte
                        Nutzungsprofile erstellt und Cookies (siehe unter Ziff.
                        4) verwendet. Die durch den Cookie erzeugten
                        Informationen über Ihre Benutzung dieser Website wie
                      </p>
                      <ol>
                        <li type="i">Browser-Typ/-Version,</li>
                        <li type="i">verwendetes Betriebssystem,</li>
                        <li type="i">
                        ...
                        <li type="i">Uhrzeit der Serveranfrage,</li>
                      </ol>
                      <p>
                        werden an einen Server von Google in den USA übertragen
                        und dort gespeichert. Die Informationen werden
                        ...
                        sofern dies gesetzlich vorgeschrieben ist oder soweit
                        Dritte diese Daten im Auftrag verarbeiten. Es wird in
                        keinem Fall Ihre IP-Adresse mit anderen Daten von Google
                        zusammengeführt. Die IP-Adressen werden anonymisiert, so
                      ...
                      <p>
                        ...
                        auf mobilen Endgeräten, können Sie die Erfassung durch
                        Google Analytics zudem verhindern, indem Sie auf diesen
                        Link klicken. Es wird ein Opt-out-Cookie gesetzt, das
                        die zukünftige Erfassung Ihrer Daten beim Besuch dieser
                        Website verhindert. Der Opt-out-Cookie gilt nur in
                        diesem Browser und nur für unsere Website und wird auf
                        Ihrem Gerät abgelegt. Löschen Sie die Cookies in diesem
                    ...
                    <li type="a">
                      ...
                      <p>
                        Um die Nutzung unserer Webseite statistisch zu erfassen
                        und zum Zwecke der Optimierung unserer Website für Sie
                        auszuwerten, nutzen wir ferner das Google Conversion
                        Tracking. Dabei wird von Google Adwords ein Cookie
                        (siehe Ziffer 4) auf Ihrem Rechner gesetzt, sofern Sie
                        über eine Google-Anzeige auf unsere Webseite gelangt
                        sind.
                      </p>
                      <p>
                        Diese Cookies verlieren nach 30 Tagen ihre Gültigkeit
                        und dienen nicht der persönlichen Identifizierung.
                        Besucht der Nutzer bestimmte Seiten der Webseite des
                        Adwords-Kunden und das Cookie ist noch nicht abgelaufen,
                        können Google und der Kunde erkennen, dass der Nutzer
                        auf die Anzeige geklickt hat und zu dieser Seite
                      ...
                      <p>
                        ...
                        Conversion-Statistiken für Adwords-Kunden zu erstellen,
                        die sich für Conversion-Tracking entschieden haben. Die
                        Adwords-Kunden erfahren die Gesamtanzahl der Nutzer, die
                        auf ihre Anzeige geklickt haben und zu einer mit einem
                        Conversion-Tracking-Tag versehenen Seite weitergeleitet
                        wurden. Sie erhalten jedoch keine Informationen, mit
                        denen sich Nutzer persönlich identifizieren lassen. Wenn
                        Sie nicht an dem Tracking-Verfahren teilnehmen möchten,
                        können Sie auch das hierfür erforderliche Setzen eines
                        Cookies ablehnen – etwa per Browser-Einstellung, die das
                        automatische Setzen von Cookies generell deaktiviert.
                        Sie können Cookies für Conversion-Tracking auch
                        deaktivieren, indem Sie Ihren Browser so einstellen,
                        dass Cookies von der Domain „www.googleadservices.com“
                        blockiert werden. Googles Datenschutzbelehrung zum
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        <span>
                          Automattic Inc., 132 Hawthorne Street, San Francisco,
                          CA 94107, USA,
                        </span>
                        Auttomattic Inc. ist nach dem EU-US-Datenschutzschild
                        („EU-US Privacy Shield“) zertifiziert und garantiert
                        Automattic, dass die Datenschutzvorgaben der EU auch bei
                        ...
                        WordPress Stats verwendet unter anderem Cookies, die auf
                        Ihrem Computer gespeichert werden und die eine Analyse
                        der Benutzung der Website ermöglicht. Im Rahmen der
                        Benutzung werden Daten, wie insbesondere die IP-Adresse
                        und Aktivitäten der Nutzer an verarbeitet und an einen
                        Server der Firma Automattic, Inc. übermittelt und dort
                        gespeichert. Ihre IP-Adresse wird allerdings noch vor
                        ihrer Speicherung anonymisiert.
                      </p>
                      <p>
                        WordPress Stats dient zur Analyse des Nutzerverhaltens.
                        Die Rechtsgrundlage ergibt sich aus Art. 6 Abs. 1 lit.
                        f) DSGVO. Unser berechtigtes Interesse liegt in der
                        Analyse und Optimierung des Internetauftritts. Falls Sie
                        mit dieser Verarbeitung nicht einverstanden sind, haben
                        Sie die Möglichkeit, die Speicherung des Cookies durch
                        eine Einstellung in Ihrem Internet-Browsers zu
                        verhindern. Weiterführende Informationen zum Datenschutz
                        bei der Nutzung von WordPress Stats können Sie unter dem
              ...
              <section>
                <li>
                  ...
                  <p>
                    Wir setzen auf unserer Website auf Grundlage des Art. 6 Abs.
                    1 S. 1 lit. f DSGVO Social Plug-ins der sozialen Netzwerke
                    Facebook, Twitter und Instagram ein, um unsere Firma
                    hierüber bekannter zu machen. Der dahinterstehende werbliche
                    Zweck ist als berechtigtes Interesse im Sinne der DSGVO
                    anzusehen. Die Verantwortung für den datenschutzkonformen
                    Betrieb ist durch deren jeweiligen Anbieter zu
                    gewährleisten. Die Einbindung dieser Plug-ins durch uns
                    erfolgt im Wege der sogenannten Zwei-Klick-Methode um
                  ...
                  <ol>
                    <li type="a">
                      Facebook
                      <p>
                        Auf unserer Website kommen Social-Media Plugins von
                        Facebook zum Einsatz, um deren Nutzung persönlicher zu
                        gestalten. Hierfür nutzen wir den „LIKE“ oder
                        „TEILEN“-Button. Es handelt sich dabei um ein Angebot
                        von Facebook.
                      </p>
                      <p>
                        Wenn Sie eine Seite unseres Webauftritts aufrufen, die
                        ein solches Plugin enthält, baut Ihr Browser eine
                        direkte Verbindung mit den Servern von Facebook auf. Der
                      ...
                      <p>
                        ...
                        Information, dass Ihr Browser die entsprechende Seite
                        ...
                        IP-Adresse) wird von Ihrem Browser direkt an einen
                        Server von Facebook in den USA übermittelt und dort
                        gespeichert.
                      </p>
                      <p>
                        Sind Sie bei Facebook eingeloggt, kann Facebook den
                        Besuch unserer Website Ihrem Facebook-Konto direkt
                        zuordnen. Wenn Sie mit den Plugins interagieren, zum
                        Beispiel den „LIKE“ oder „TEILEN“-Button betätigen, wird
                        die entsprechende Information ebenfalls direkt an einen
                        Server von Facebook übermittelt und dort gespeichert.
                        Die Informationen werden zudem auf Facebook
                      ...
                      <p>
                        ...
                        Nutzungs-, Interessen- und Beziehungsprofile erstellt,
                        z. B. um Ihre Nutzung unserer Website im Hinblick auf
                        die Ihnen bei Facebook eingeblendeten Werbeanzeigen
                        auszuwerten, andere Facebook-Nutzer über Ihre
                        Aktivitäten auf unserer Website zu informieren und um
                        weitere mit der Nutzung von Facebook verbundene
                        Dienstleistungen zu erbringen.
                      </p>
                      <p>
                        Wenn Sie nicht möchten, dass Facebook die über unseren
                        Webauftritt gesammelten Daten Ihrem Facebook-Konto
                        zuordnet, müssen Sie sich vor Ihrem Besuch unserer
                        Website bei Facebook ausloggen. Zweck und Umfang der
                        Datenerhebung und die weitere Verarbeitung und Nutzung
                        der Daten durch Facebook sowie Ihre diesbezüglichen
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        Kurznachrichtennetzwerks der Twitter Inc. (Twitter)
                        integriert. Die Twitter-Plugins (tweet-Button) erkennen
                        Sie an dem Twitter-Logo auf unserer Seite. Eine
                        Übersicht über tweet-Buttons finden Sie hier
                        <a
                          className="email"
                      ...
                      <p>
                        {" "}
                        Wenn Sie eine Seite unseres Webauftritts aufrufen, die
                        ein solches Plugin enthält, wird eine direkte Verbindung
                        zwischen Ihrem Browser und dem Twitter-Server
                        hergestellt. Twitter erhält dadurch die Information,
                        dass Sie mit Ihrer IP-Adresse unsere Seite besucht
                        haben. Wenn Sie den Twitter „tweet-Button“ anklicken,
                        während Sie in Ihrem Twitter-Account eingeloggt sind,
                        können Sie die Inhalte unserer Seiten auf Ihrem
                        Twitter-Profil verlinken. Dadurch kann Twitter den
                        Besuch unserer Seiten Ihrem Benutzerkonto zuordnen. Wir
                        weisen darauf hin, dass wir als Anbieter der Seiten
                        keine Kenntnis vom Inhalt der übermittelten Daten sowie
                        deren Nutzung durch Twitter erhalten. Wenn Sie nicht
                        wünschen, dass Twitter den Besuch unserer Seiten
                        zuordnen kann, loggen Sie sich bitte aus Ihrem
                        Twitter-Benutzerkonto aus. Weitere Informationen hierzu
                    ...
                    <li type="a">
                      Instagram{" "}
                      <p>
                        Auf unserer Website werden auch sogenannte Social
                        Plugins („Plugins“) von Instagram verwendet, das von
                        <span>
                          Instagram LLC., 1601 Willow Road, Menlo Park, CA
                          94025, USA („Instagram“) betrieben wird. Die Plugins
                          sind mit einem Instagram-Logo beispielsweise in Form
                          einer „Instagram-Kamera“ gekennzeichnet.
                        </span>
                      </p>
                      <p>
                        Wenn Sie eine Seite unseres Webauftritts aufrufen, die
                        ein solches Plugin enthält, stellt Ihr Browser eine
                        direkte Verbindung zu den Servern von Instagram her. Der
                        Inhalt des Plugins wird von Instagram direkt an Ihren
                        Browser übermittelt und in die Seite eingebunden. Durch
                        diese Einbindung erhält Instagram die Information, dass
                        Ihr Browser die entsprechende Seite unseres Webauftritts
                        aufgerufen hat, auch wenn Sie kein Instagram-Profil
                        besitzen oder gerade nicht bei Instagram eingeloggt
                        sind.
                      </p>
                      <p>
                        Diese Information (einschließlich Ihrer IP-Adresse) wird
                        von Ihrem Browser direkt an einen Server von Instagram
                        in die USA übermittelt und dort gespeichert. Sind Sie
                        bei Instagram eingeloggt, kann Instagram den Besuch
                        unserer Website Ihrem Instagram-Account unmittelbar
                        zuordnen. Wenn Sie mit den Plugins interagieren, zum
                        Beispiel das „Instagram“-Button betätigen, wird diese
                        Information ebenfalls direkt an einen Server von
                        Instagram übermittelt und dort gespeichert.
                      </p>
                      <p>
                        Die Informationen werden außerdem auf Ihrem
                        Instagram-Account veröffentlicht und dort Ihren
                        Kontakten angezeigt. Wenn Sie nicht möchten, dass
                        Instagram die über unseren Webauftritt gesammelten Daten
                        unmittelbar Ihrem Instagram-Account zuordnet, müssen Sie
                        sich vor Ihrem Besuch unserer Website bei Instagram
                        ausloggen. Weitere Informationen hierzu Sie in der
                    ...
                    <li type="a">
                      ...
                      <ol>
                        <li>
                          <p>
                            {" "}
                            In unserem Online-Angebot sind YouTube-Videos
                            eingebunden, die auf{" "}
                            <a className="email" href="http://www.YouTube.com">
                              http://www.YouTube.com
                            </a>{" "}
                            gespeichert sind. Diese können von unserer Website
                            aus unmittelbar abgespielt werden. Die Videos sind
                            alle im „erweiterten Datenschutz-Modus“ eingebunden.
                            Dadurch werden keine Daten an YouTube übertragen
                            werden, wenn Sie die Videos nicht abspielen. Erst
                            wenn Sie die Videos abspielen, werden die
                            nachfolgend genannten Daten übertragen. Auf diese
                            Datenübertragung haben wir jedoch keinen Einfluss.
                          </p>
                        </li>
                        <li>
                          <p>
                            {" "}
                            Bei einem Besuch auf der Website erhält YouTube die
                            Information, dass Sie die entsprechende Unterseite
                            aufgerufen haben. Zudem werden die unter (Google
                            Baustein) genannten Daten übermittelt. Dies erfolgt
                            unabhängig davon, ob ein Nutzerkonto besteht.
                            Sollten Sie bei Google eingeloggt sein, werden Ihre
                            Daten direkt Ihrem Konto zugeordnet. Wenn Sie die
                            Zuordnung mit Ihrem Profil bei YouTube nicht
                            wünschen, müssen Sie sich vor Aktivierung des
                            Buttons ausloggen. YouTube speichert Ihre Daten als
                            Nutzungsprofile und nutzt sie für Zwecke der
                            Werbung, Marktforschung und/oder bedarfsgerechten
                            Gestaltung seiner Website. Eine solche Auswertung
                            erfolgt insbesondere (selbst für nicht eingeloggte
                            Nutzer) zur Erbringung von bedarfsgerechter Werbung
                            und um andere Nutzer des sozialen Netzwerks über
                            Ihre Aktivitäten auf unserer Website zu informieren.
                            Ihnen steht ein Widerspruchsrecht zu gegen die
                        ...
                        <li>
                          <p>
                            ...
                            erhalten Sie in der Datenschutzerklärung. Dort
                            erhalten Sie auch weitere Informationen zu Ihren
                            Rechten und Einstellungsmöglichkeiten zum Schutz
                            Ihrer Privatsphäre:{" "}
                            <a
                              className="email"
                            ...
                            . Google verarbeitet Ihre personenbezogenen Daten
                            auch in den USA und hat sich dem
                    ...
                    <li type="a">
                      ...
                      <p>
                        ...
                        Anbieter Vimeo. Vimeo wird betrieben von Vimeo,
                        <span>
                          {" "}
                          LLC mit Hauptsitz in 555 West 18th Street, New York,
                          New York 10011
                        </span>
                        Auf einigen unserer Internetseiten verwenden wir Plugins
                        des Anbieters Vimeo. Wenn Sie die mit einem solchen
                        Plugin versehenen Internetseiten unserer Internetpräsenz
                        aufrufen – beispielsweise unsere Mediathek –, wird eine
                        Verbindung zu den Vimeo-Servern hergestellt und dabei
                        das Plugin dargestellt.
                      </p>
                      <p>
                        Hierdurch wird an den Vimeo-Server übermittelt, welche
                        unserer Internetseiten Sie besucht haben. Sind Sie dabei
                        als Mitglied bei Vimeo eingeloggt, ordnet Vimeo diese
                        Information Ihrem persönlichen Benutzerkonto zu. Bei
                        Nutzung des Plugins wie z.B. Anklicken des Start-Buttons
                        eines Videos wird diese Information ebenfalls Ihrem
                        Benutzerkonto zugeordnet. Sie können diese Zuordnung
                        verhindern, indem Sie sich vor der Nutzung unserer
                        Internetseite aus ihrem Vimeo-Benutzerkonto abmelden und
                        die entsprechenden Cookies von Vimeo löschen.
                      </p>
                      <p>
                        Weitere Informationen zur Datenverarbeitung und Hinweise
                        zum Datenschutz durch Vimeo finden Sie unter
                        <a className="email" href="https://vimeo.com/privacy.">
              ...
              <section>
                <li>
                  ...
                  <p>
                    ...
                    <a className="email" href="kwameboama@hotmail.com">
                      kwameboama@hotmail.com
                    </a>
                  </p>
                </li>
